...
Blockly.Language.maze_moveSteps = {
  // Block for moving forward or backwards.
  category: 'Commands',
  helpUrl: 'http://code.google.com/p/blockly/wiki/Move',
  init: function() {
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('Moves Pegman forward or backward the specified spaces.');
  }
};

Blockly.Language.maze_moveSteps.DIRECTIONS =
...
Blockly.Language.maze_isVisible = {
  // Block for checking if there a wall.
  category: 'Logic',
  helpUrl: 'http://code.google.com/p/blockly/wiki/Wall',
  init: function() {
    ...
    this.appendDummyInput()
        .appendTitle('visible')
    this.setTooltip('Returns true if Romo is visible.');
  }
};

Blockly.JavaScript.maze_isVisible = function() {
  // Generate JavaScript for checking if there is a wall.
  var code = 'Maze.isVisible()';
  return [code, Blockly.JavaScript.ORDER_FUNCTION_CALL];
};
...
Blockly.Language.controls_forever = {
  ...
  init: function() {
    this.setColour(120);
    this.appendDummyInput().appendTitle('repeat forever');
...
function init() {
  ...
  var newLanguage = {};
  var keepers = ['maze_move', 'maze_moveSteps', 'maze_turnLeft', 'maze_turnRight',
      'maze_isWall', 'maze_isVisible', 'controls_if', 'controls_if_if', 'controls_if_elseif',
