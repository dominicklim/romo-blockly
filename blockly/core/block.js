...
Blockly.Block.terminateDrag_ = function() {
  ...
  if (Blockly.Block.dragMode_ == 2) {
    ...
    if (Blockly.selected) {
      ...
      // console.log('terminateDrag fire svgResize');
...
Blockly.Block.prototype.onMouseDown_ = function(e) {
  ...
  // console.log('mouse down svgResize');
  Blockly.svgResize();
